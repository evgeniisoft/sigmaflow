...
'    source: computed',
'    formula: "PROD_HEADCOUNT * PROD_AVG_SALARY * (1 + LABOR_INDEX * 0.08)"',
'',
'  - id: PROD_HEADCOUNT',
'    type: INPUT',
...
'    label: "ФОТ АУП"',
'    source: computed',
'    formula: "ADMIN_HEADCOUNT * ADMIN_AVG_SALARY * (1 + LABOR_INDEX * 0.05)"',
'',
'  - id: ADMIN_HEADCOUNT',
'    type: INPUT',
