var DEMO_FULL = 'project:\n name: "Полная модель компании (демо)"\n version: 2\n\nnodes:\n - id: NET_PROFIT\n type:
...
EXTERNAL\n label: "Ставка ЦБ"\n value: 18.0\n min: 5\n max: 25\n source: manual\n enabled: true\n\n - id: PMI\n type:
EXTERNAL\n label: "Индекс PMI"\n value: 52.0\n min: 40\n max: 65\n source: manual\n enabled: true\n\n - id: CCI\n type:
EXTERNAL\n label: "Потребительская уверенность (CCI)"\n value: -8.0\n min: -40\n max: 10\n source: manual\n enabled:
...
source: manual\n enabled: true\n\n - id: SPI\n type: INPUT\n label: "Индекс пирамиды зарплат (SPI)"\n value: 4.2\n min:
1.0\n max: 10.0\n source: manual\n enabled: true\n\n - id: ATTRITION\n type: INTERMEDIATE\n label: "Текучесть
...
value: 0.10\n min: 0.05\n max: 0.20\n source: manual\n enabled: true\n\n - id: WEAR\n type: INTERMEDIATE\n label: "Износ
оборудования"\n source: computed\n\n - id: CAPEX\n type: INPUT\n label: "Капитальные затраты (CAPEX)"\n value: 800000\n
min: 0\n max: 3000000\n source: manual\n enabled: true\n\n - id: CAPACITY_UTIL\n type: INPUT\n label: "Загрузка
...
BANK_SPREAD\n type: INPUT\n label: "Спред банка"\n value: 0.03\n min: 0.01\n max: 0.08\n source: manual\n enabled:
true\n\n - id: RATE_TYPE\n type: INPUT\n label: "Тип ставки (1=фикс, 0=плавающая)"\n value: 0\n min: 0\n max: 1\n
source: manual\n enabled: true\n\n - id: CREDIT_RATING\n type: INPUT\n label: "Кредитный рейтинг"\n value: 0.70\n min:
0.2\n max: 1.0\n source: manual\n enabled: true\n\n - id: DEBT_EBITDA\n type: INTERMEDIATE\n label: "Debt/EBITDA"\n
source: computed\n\n - id: FCF\n type: INTERMEDIATE\n label: "Свободный денежный поток (FCF)"\n source: computed\n\n -
id: CFO\n type: INTERMEDIATE\n label: "Операционный денежный поток (CFO)"\n source: computed\n\n - id: CFI\n type:
INTERMEDIATE\n label: "Инвестиционный денежный поток (CFI)"\n source: computed\n\n - id: CFF\n type: INTERMEDIATE\n
label: "Финансовый денежный поток (CFF)"\n source: computed\n\n - id: delta_RECEIVABLES\n type: INPUT\n label:
